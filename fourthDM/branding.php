...
<html lang="en">
  ...
  <body>
    ...
    <section class="information">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-12 px-5 align-items-center ">
                <span>Branding</span>
                <h3> Why  Branding  is Important</h3>

                <p>Branding is a combination of marketing and business strategies 
                    that help people think about a company,
                    a product, or a person in a particular way.
                    Regardless of your industry, you always need to consider your 
                    competitors and what you can do to set your business apart. 
                    With the right branding, this can be achieved.
                    * Branding enhances recognition.
                    * Your brand helps you stand out from the competition.
                    * Your brand tells people about your company’s DNA.
                    * A strong brand generates referrals.
                    *Your brand helps you connect with your customers emotionally.
                    
                    Remember, your branding needs to remain uniform across the board.</p>
                <div class="check">
                    <p> <i class="fa-regular fa-square-check" style="color: #ffac46";></i> &nbsp;Branding increases business value</p>

                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i> &nbsp; Branding generates new customers</p>

                    <p> <i class="fa-regular fa-square-check" style="color: #ffac46";></i> &nbsp;Creates trust within the marketplace
                    </p>

                    <p> <i class="fa-regular fa-square-check" style="color: #ffac46";></i> &nbsp; Branding supports advertising
                    </p>

                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i> &nbsp;Branding inspires employees
                    </p>
                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i> &nbsp;Branding builds financial value
                    </p></div>
            </div>
            <div class="col-md-6 col-lg-6 col-12">
                <img src="img/32.png" alt="" style="align-items: right;">
            </div>
        </div>
        </div>
    </section>

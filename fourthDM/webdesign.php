    ...
    <section class="information">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-12 px-5 align-items-center">
                ...
                <h3> Why  Website  is Important</h3>

                <p>Develop your Website to show off your work. 
                    Having a website is an opportunity to make a great first impression
                    and give people comfort that you're a real business.
                    Website is essential for offering social proof and establishing 
                    your credibility as a business. 
                    If you want to succeed in business, invest in a website. 
                    It’s the best way to offer 
                    social proof and build trust with potential customers.</p>
                <div class="check">
                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i> &nbsp; Brand Awareness </p>

                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i> &nbsp; Improves Credibility</p>

                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i>  &nbsp; Attract Organic Traffic
                    </p>

                    <p> <i class="fa-regular fa-square-check" style="color: #ffac46";></i> &nbsp;  Generating Leads, Increasing Sales
                    </p>

                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i>   &nbsp; Improve Customer Experience
                    </p>
                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i>  &nbsp;  Updates And Announcements
                    </p>
                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i>   &nbsp; Digital Marketing
                    </p>

    ...
    <section class="information">
        ...
        <div class="row p-5">
            <div class="col-md-6 col-lg-6 col-12 px-5 align-items-center ">
                ...
                <h3>Why  Social Media  is Important</h3>

                <p>Social media for business is no longer optional. 
                    It's an essential way to reach your customers, gain valuable 
                    insights, and grow your brand. 
                    With over half of the world’s population using social media, 
                    platforms like 
                    Facebook, Instagram or Twitter a natural place to 
                    reach new
                    and highly targeted potential customers.
                    </p>
                <div class="check">
                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i>&nbsp; Generate leads and customers</p>

                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i>&nbsp; Drive traffic</p>

                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i>&nbsp;Build Public relationships
                    </p>

                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i>&nbsp; Humanize your business
                    </p>

                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i>&nbsp; Get Attention and Build Awareness
                    </p>
                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i> &nbsp;Communicate Authority
                    </p>
                    <p><i class="fa-regular fa-square-check" style="color: #ffac46";></i>&nbsp;Show Authenticity
                    </p></div>
            </div>
